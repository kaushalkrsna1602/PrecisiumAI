        ...
        <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
                ...
                <MotionH3
                    ...
                    className="font-bold text-3xl max-w-2xl mx-auto">Transform any PDF into an easy-to-digest summary in three simple steps
                </MotionH3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative">
                {steps.map((step, idx) => (
                    <MotionDiv
                        ...
                        key={idx} className="relative flex items-stretch">
                        <StepItem  {...step} />
