        ...
        <div className="px-2 py-12 sm:py-24">
          ...
          {hasReachedLimit && (
            <MotionDiv
              ...
              className="mb-6"
            >
              <div className="bg-rose-50 boder border-rose-200 rounded-lg p-4 text-rose-800">
                <p className="text-sm">
                  You've reached the limit of {uploadLimit} on the Basic plan.{' '}
                  <Link
                    href="/#pricing"
                    className="text-rose-600 underline font-medium underline-offset-4 inline-flex items-center"
                  >
